...
require_text "Core mDNS reusable socket" "rs-core/src/scanner/mdns.rs" "fn bind_mdns_socket"
...
require_text "PC mDNS implementation" "netprowl-pc/src-tauri/src/scanner/mdns.rs" "rs_core::scanner::mdns::discover_mdns"
require_text "PC mDNS error visibility" "netprowl-pc/src-tauri/src/scanner/mdns.rs" "mDNS discovery unavailable"
