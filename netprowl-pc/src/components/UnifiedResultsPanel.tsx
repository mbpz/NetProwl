...
const TAG_COLORS: Record<ResultType, string> = { port: 'bg-blue-100 text-blue-800', service: 'bg-green-100 text-green-800', vuln: 'bg-red-100 text-red-800', fuzz: 'bg-yellow-100 text-yellow-800' };
