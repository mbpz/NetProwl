...
export function PipelinePanel() {
  ...
  const start = async () => {
    ...
    setPhase('scanning');
    try {
      const results = await invoke('start_pipeline', { opts: { target, scan_tool: selectedTool, auto_nuclei: autoNuclei, auto_ffuf: false, auto_feroxbuster: false, port_range: portRange, rate }});
