...
export function PipelinePanel() {
  ...
  const start = async () => {
    ...
    setPhase('scanning');
    try {
      const results = await invoke('run_pipeline', { opts: { target: '192.168.1.0/24', scan_tool: selectedTool, auto_nuclei: autoNuclei, auto_ffuf: false, auto_feroxbuster: false } });
