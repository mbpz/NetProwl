...
// AWS IP ranges (first three octets)
const AWS_IP_RANGES: &[&str] = &[
    "3.0.0.0/8", "10.0.0.0/8", "50.0.0.0/8", "52.0.0.0/10", "54.0.0.0/10",
    "75.0.0.0/10", "96.0.0.0/10", "104.0.0.0/10", "108.0.0.0/10",
    "172.0.0.0/10", "176.0.0.0/10", "184.0.0.0/10",
];

// Aliyun IP ranges
const ALIYUN_IP_RANGES: &[&str] = &[
    "39.0.0.0/8", "42.0.0.0/8", "47.0.0.0/8", "49.0.0.0/8",
    "101.0.0.0/9", "103.0.0.0/9", "106.0.0.0/8", "119.0.0.0/8",
    "120.0.0.0/8", "121.0.0.0/8", "140.0.0.0/8", "192.168.0.0/16",
];

// Tencent IP ranges
const TENCENT_IP_RANGES: &[&str] = &[
    "1.0.0.0/8", "14.0.0.0/8", "27.0.0.0/8", "36.0.0.0/8",
    "43.0.0.0/8", "49.0.0.0/8", "58.0.0.0/8", "59.0.0.0/8",
    "103.0.0.0/8", "110.0.0.0/8", "112.0.0.0/8", "117.0.0.0/8",
    "119.0.0.0/8", "120.0.0.0/8", "121.0.0.0/8", "123.0.0.0/8",
    "124.0.0.0/8", "125.0.0.0/8", "129.0.0.0/8", "140.0.0.0/8",
    "175.0.0.0/8", "183.0.0.0/8", "202.0.0.0/8", "203.0.0.0/8",
    "210.0.0.0/8", "211.0.0.0/8", "218.0.0.0/8", "220.0.0.0/8",
];

// GCP IP ranges
const GCP_IP_RANGES: &[&str] = &[
    "23.0.0.0/10", "34.0.0.0/9", "35.0.0.0/9", "104.0.0.0/10",
    "107.0.0.0/10", "108.0.0.0/10", "130.0.0.0/8", "142.0.0.0/9",
    "146.0.0.0/9", "162.0.0.0/10", "166.0.0.0/10",
];
